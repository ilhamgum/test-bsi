    ...
    <header className="flex h-16 items-center justify-between border-b border-gray-200 bg-white px-4 lg:px-6">
      ...
      <div className="flex items-center gap-3">
        ...
        <select
          ...
          className="rounded-md border border-gray-300 px-3 py-1.5 text-sm font-medium text-gray-700 focus:border-blue-500 focus:outline-none focus:ring-1 focus:ring-blue-500"
